...
//     // Obtener el usuario actual desde la base de datos utilizando el ID del token
//     // Verificar el rol del usuario
//     if (req.user.role !== 'admin') {
//         return res.status(403).json({ message: 'Acceso no autorizado. Debes ser administrador.' });
//     }
//     next();
// };
